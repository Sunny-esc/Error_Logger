...
import sign from '../assets/svgs/sign.svg'; 
 const Loginbutton2=()=>{
      ...
      return( 
          <>
        <button
      className="flex items-center gap-1 hover:text-blue-400  px-4 sm:px-6 py-2 text-sm sm:text-base bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition"
